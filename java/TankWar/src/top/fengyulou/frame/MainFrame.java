...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        addListener();//添加事件监听
        setPanel(new LoginPanel(this));//添加登录面板
    }
    ...
    private void addListener() {
        addWindowListener(new WindowAdapter() {//添加窗体事件
            @Override
            public void windowClosing(WindowEvent e) {//窗体关闭时
                int closeCode = JOptionPane.showConfirmDialog(MainFrame.this, "是否退出游戏？", "提示！", JOptionPane.YES_NO_OPTION);//弹出选择对话框，并记录用户选择
