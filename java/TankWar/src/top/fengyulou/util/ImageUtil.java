...
public class ImageUtil {
    //玩家1向上图片路径
    public static final String PLAYER1_UP_IMAGE_URL="image/tank/player1_up.png";
    //玩家1向下图片路径
    public static final String PLAYER1_DOWN_IMAGE_URL="image/tank/player1_down.png";
    //玩家1向左图片路径
    public static final String PLAYER1_RIGHT_IMAGE_URL="image/tank/player1_left.png";
    //玩家1向右图片路径
    public static final String PLAYER1_LEFT_IMAGE_URL="image/tank/player1_right.png";
    //玩家2向上图片路径
    public static final String PLAYER2_UP_IMAGE_URL="image/tank/player2_up.png";
    //玩家2向下图片路径
    public static final String PLAYER2_DOWN_IMAGE_URL="image/tank/player2_down.png";
    //玩家2向左图片路径
    public static final String PLAYER2_RIGHT_IMAGE_URL="image/tank/player2_left.png";
    //玩家2向右图片路径
    public static final String PLAYER2_LEFT_IMAGE_URL="image/tank/player2_right.png";
    //电脑向上图片路径
    ...
    //登录面板背景图片路径
    public static final String LOGIN_BACKGROUND_IMAGE_URL="image/login_background.png";
}
